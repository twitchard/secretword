...
-- All the 5 letter words in /usr/share/dict/american-english
-- Accept guesses from these words
recognizedFiveLetterWords :: Set String
recognizedFiveLetterWords = fromFoldable
  [ "aback"
  , "abaft"
  , "abase"
  , "abash"
